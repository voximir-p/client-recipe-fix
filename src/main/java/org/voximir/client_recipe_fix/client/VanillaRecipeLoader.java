...
public class VanillaRecipeLoader {
     ...
     *         to a list of concrete item ResourceLocations (e.g. {@code minecraft:oak_planks})
     */
    ...
    /**
     * Recursively resolves a tag to a flat list of concrete item ResourceLocations.
     */
     ...
     * item ResourceLocations that belong to that tag.  This allows the recipe codec
